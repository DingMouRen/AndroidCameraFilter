...
Java_com_dingmouren_camerafilter_utils_YUVConvert_YUVtoRBGA(JNIEnv *env, jobject obj,
...
JNIEXPORT void JNICALL
Java_com_dingmouren_camerafilter_utils_YUVConvert_YUVtoARBG(JNIEnv *env, jobject obj,
                                                            jbyteArray yuv420sp, jint width,
                                                            jint height, jintArray rgbOut) {
    int sz;
    int i;
